...
Clara.sendMessage(m.chat, { video: { url: anu.data.video }, caption: `Username: ${anu.data.username}
...
/*case 'mediafire': {
if (!q) return replygc(`Contoh: 
${prefix + command} https://www.mediafire.com/file/pwxob70rpgma9lz/GBWhatsApp_v8.75%2528Tutorial_Yud%2529.apk/file`)
replygc(mess.wait)
let anu = await fetchJson(`https://api.xyroinee.xyz/api/downloader/mediafire?url=${q}&apikey=${xyrokey}`)
Clara.sendMessage(m.chat, { document: { url: anu
data.url }, fileName: anu.data.title+'.zip' , mimetype: 'application/zip' }, { quoted: m })
}
break*/
// ===================================== //
case 'google': {
...
Clara.sendMessage(m.chat, { video: { url: video.data.url }, caption: ngen }, {quoted: m})
}
break
// ===================================== //
case 'yta':  
